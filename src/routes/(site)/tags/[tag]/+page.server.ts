...
// matches the live permalink contract (`/tags/<tag>/`, trailing slash), which the sitemap and
// every prerendered tag link (the tag index, each post's row) already target.
